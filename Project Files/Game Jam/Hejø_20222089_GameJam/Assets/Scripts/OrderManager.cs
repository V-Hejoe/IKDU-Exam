...
public class OrderManager : MonoBehaviour
{
    ...
    /// <summary>
    /// This method is used to remove an order and manage the elements surrounding it. It was supposed to include the time remaining in the calculations of the earnings, but it was not implemented in time.
    /// </summary>
